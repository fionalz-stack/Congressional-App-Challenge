...
export default function MapScreen() {
  ...
  const busLocations: BusLocation[] = [
    { id: "1", latitude: 15.21, longitude: 145.75, route: "16", heading: 45 },
    { id: "2", latitude: 15.22, longitude: 145.76, route: "8", heading: 180 },
    {
      id: "3",
      latitude: 15.205,
      longitude: 145.745,
  ...
  const routeOptions: RouteOption[] = [
    ...
    },
    {
      id: "2",
      route: "Route 8",
      destination: "Garapan Tourist District",
      duration: "15 min",
      nextBus: "7 min",
    },
    {
      id: "3",
      route: "Route 12",
      destination: "Northern Marianas College",
      duration: "20 min",
      nextBus: "5 min",
    },
  ];
  ...
  const nextArrivals: Arrival[] = [
    ...
    {
      id: "3",
      route: "Saipan International Airport",
      time: "8 min",
      type: "bus",
    },
            ...
            >
              ...
              {showSearchResults && (
                <View
                  className="mt-2"
                  style={{
                    maxHeight: SCREEN_HEIGHT * SEARCH_RESULTS_MAX_HEIGHT_RATIO,
                  }}
                >
                  <CNMICard variant="elevated">
                    <ScrollView
                      ...
                      {filteredDestinations.map((destination) => (
                        ...
                        >
                          <Ionicons
                            ...
                            style={{ marginRight: 12 }}
                          />
                          <Text className="flex-1 text-base font-medium text-typography-900 dark:text-typography-900">
                            {destination.name}
                          </Text>
                        </TouchableOpacity>
                      ))}
                ...
                <View className="flex-row items-center justify-between">
                  <View className="flex-1">
                    ...
                    <Text className="text-sm text-typography-600 dark:text-typography-400">
                      Next arrival: 2 min • To {selectedDestination}
                    </Text>
                  </View>
                  <TouchableOpacity
                    onPress={() => {
                    ...
                    {routeOptions.map((route) => (
                      ...
                      >
                        ...
                        <View className="items-end">
                          <Text className="font-semibold text-cnmi-primary">
                            {route.nextBus}
                          </Text>
                  ...
                  <View>
                    ...
                    {nearbyTaxis.map((taxi) => (
                      ...
                      >
                        ...
                        <View className="items-end">
                          <Text className="font-semibold text-cnmi-accent">
                            {taxi.time}
                          </Text>
